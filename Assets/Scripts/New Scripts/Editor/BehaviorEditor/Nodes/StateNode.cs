...
namespace SA.BehaviorEditor
{
    ...
    public class StateNode : DrawNode
    {
            ...
            if (b.stateRef.currentState != null)
            {
                ...
                if (!b.collapse)
                {
					...
					if (b.showActions)
					{
						...
						b.stateRef.onActionList.DoLayoutList();
						standard += 100 + (b.stateRef.onActionList.count) * 20;
					}
					...
					if (b.showEnterExit)
					{
						...
						standard += 180 + (b.stateRef.onEnterList.count + b.stateRef.onExitList.count) * 20;
					}
		...
		void SetupReordableLists(BaseNode b)
		{
			...
			b.stateRef.onActionList = new ReorderableList(b.stateRef.serializedState, b.stateRef.serializedState.FindProperty("onAction"), true, true, true, true);
			...
			HandleReordableList(b.stateRef.onActionList, "On Action");
